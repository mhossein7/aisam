...
class CcaSR_Inverter(gillespy2.Model):
    ...
    def init_rxn(self):
        alpha , beta, k_tet , k , n ,n_tet, tau_delay , h1 , h2 , c2,delta = self.params
        ...
        self.add_parameter([alpha_g,beta_g,delta_g,c2_g,k_g,k_tet_g,n_g,n_tet_g,tau_delay_g,h1_g,h2_g])
